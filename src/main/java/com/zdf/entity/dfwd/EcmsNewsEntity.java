...
*
* @ClassName: EcmsNews
* @Description: 映射www_96kaifa_com_ecms_news表
* @author: zhongdifeng
*
*/
public class EcmsNewsEntity implements Serializable {
    ...
    */
	...
	public Integer getDiggtop() {
		return diggtop;
	}
	public void setDiggtop(Integer diggtop) {
