...
@Component
public class SqlkkkkbaVideos implements PageProcessor {
    private final Logger             logger = Logger.getLogger(SqlkkkkbaVideos.class);
...
//        				logger.info(names.get(i) + " -- "+ domain + links.get(i));
    ...
    public static void main(String[] args) {
    	//播放连接列表页
    	Request request = new Request("http://www.kkkkba.com/Europe/baizhantianlongdiyiji/");
...
//    	request.putExtra("mouleType", Website4kba.KKKK_YOUYUN.getCode());
    	...
    	SqlkkkkbaVideos sqlkkkkbaVideos = new SqlkkkkbaVideos();
