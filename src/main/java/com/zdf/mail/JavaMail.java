...
/**
 * Created by zhongdf on 2016/6/22.
 */
@Component
public class JavaMail {
    ...
    private static class SingletonHolder {
        private static final JavaMail INSTANCE = new JavaMail(false);
    }
    public static final JavaMail getInstance() {  
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
        ...
        try {
            ...
            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("我爱看美剧")+" <"+sender_username+">");
    ...
    public static void main(String[] args) {
        ...
        se.doSendHtmlEmail("邮件主题", "邮件内容", "657159029@qq.com");
    }
}
